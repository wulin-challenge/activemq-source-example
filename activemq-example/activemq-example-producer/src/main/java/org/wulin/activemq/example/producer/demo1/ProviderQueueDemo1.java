...
public class ProviderQueueDemo1 {

	public static void main(String[] args) throws Exception {
		ProviderQueueDemo1 provider = new ProviderQueueDemo1();
		provider.testMQProducerQueue();
	}
...
//        
//        MBeanServerInvocationHandler.newProxyInstance(connection, name, interfaceClass, notificationBroadcaster);
        //9、关闭资源
        producer.close();
        session.close();
        connection.close();
